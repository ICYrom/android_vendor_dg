...
ALARM_PATH := vendor/dg/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dg/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dg/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/dg/prebuilt/common/media/audio/ui
